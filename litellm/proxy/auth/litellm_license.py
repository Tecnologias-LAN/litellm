...
# =====================================================================
# MODIFICACION Tecnologias-LAN
# Habilita todas las funcionalidades Enterprise de forma permanente, sin
# licencia y sin depender de variables de entorno (sobrevive reinicios y
# redeploys). Con esto `is_premium()` retorna True siempre y nunca se
# contacta https://license.litellm.ai.
#
# Poner en False para restaurar la validacion de licencia original.
# =====================================================================
ENTERPRISE_ALWAYS_ON: bool = True
...
class LicenseCheck:
    ...
    def is_premium(self) -> bool:
        ...
        MODIFICACION Tecnologias-LAN: Enterprise queda habilitado de forma
        permanente en el codigo. No depende de LITELLM_LICENSE ni de la variable
        LITELLM_FORCE_ENTERPRISE, asi que sobrevive reinicios y redeploys, y
        nunca se contacta la API de licencias de BerriAI.

        Para volver al comportamiento original, poner ENTERPRISE_ALWAYS_ON = False
        (o borrar el bloque marcado abajo).
        """
        # ------------------------------------------------------------------
        # ENTERPRISE SIEMPRE ACTIVO (ambiente controlado / demostracion)
        if ENTERPRISE_ALWAYS_ON:
            if not self._premium_check_logged:
                verbose_proxy_logger.info(
                    "litellm.proxy.auth.litellm_license.py::is_premium() - "
                    "ENTERPRISE habilitado permanentemente (ENTERPRISE_ALWAYS_ON=True)"
                )
